...
export default function Adults({ onOpenModal }) {
  return (
    <>
      <section className="main-container">
        ...
        <div className="main-content">
          ...
          <div className="costumes-image">
            ...
            <img
              src={
                images["514277018_23993052487022761_7832565373468687738_n.jpg"]
              }
              alt="main adult"
              className="main-img"
            />
            <img
              src={
                images["514277854_24004988872495789_4353467111188391412_n.jpg"]
              }
              alt="main adult"
              className="main-img"
            />
            ...
            <img
              src={
                images["515074334_24003734919287851_7337668467363067280_n.jpg"]
              }
              alt="main adult"
              className="main-img"
            />

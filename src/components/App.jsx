          ...
          <section className="main-container">
            ...
            <div className="main-text">
              <p>
                ...
                Свято осені, 🥼 День вишиванки — ми завжди готові допомогти
                обрати ідеальний образ для кожної події.
                <br />
                Заходьте, обирайте, приміряйте — і нехай ваша дитина (чи ви
                самі) сяє на святі, мов ⭐ зірка!

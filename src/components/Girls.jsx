...
export default function Girls({ onOpenModal }) {
  return (
    <>
      <section className="main-container">
        ...
        <div className="main-content">
          ...
          <div className="costumes-image">
            ...
            />
            <img
              src={images["495584819_9840616936026220_58914296813680645_n.jpg"]}
              alt="main girl"
              className="main-img"
            />
            <img
            ...
            <img
              src={
                images["514584993_24005286035799406_2754936590086818921_n.jpg"]
              }
              alt="main girl"
              className="main-img"
            />
            ...
            <img
              src={
                images["515675535_24009714248689918_7192348704650212544_n.jpg"]
              }
              alt="main girl"
              className="main-img"
            />
